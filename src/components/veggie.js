    ...
    <div className="Veggie col-4">
      <div className="card">
        ...
        <div className="card-body">
          ...
          <p className="card-text">You trying to be healthy but still can't resist pizza? Well then the veggie slice is for you! This is guilt-free pizza at its finest.</p>
        </div>
